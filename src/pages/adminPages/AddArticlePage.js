    ...
    <div className= {classes.card}>
      <form className={classes.form} onSubmit={submitHandler} >
        ...
        <br />
          ...
          <input className={classes.textarea} required type='text' id='title' ref={titleRef}/><p/>
          <label className={classes.label} htmlFor= 'content'>Content</label>
          <textarea className={classes.textarea} required id='content' placeholder='article content here' rows='10' ref={contentRef}></textarea><p/>
